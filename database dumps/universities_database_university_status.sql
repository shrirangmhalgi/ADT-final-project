...
--
-- Table structure for table `university_status`
--

DROP TABLE IF EXISTS `university_status`;
...
--
-- Dumping data for table `university_status`
--

LOCK TABLES `university_status` WRITE;
/*!40000 ALTER TABLE `university_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `university_status` ENABLE KEYS */;
UNLOCK TABLES;
